    ...
    <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-6 lg:max-w-7xl lg:px-8">
        ...
        <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-4">
          {products.map((item) => (
            <div className="border-2	rounded-md	p-2 -bottom-10 hover:bg-gray-800 hover:text-white cursor-pointer">
              ...
              <h2 className="mt-3 text-lg capitalize">abc</h2>
              <p className="text-base mt-1 ml-1 inline-block">$40</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <ol className=" w-full p-3 space-x-2 text-sm font-medium text-center text-gray-500 bg-white border border-gray-200 rounded-lg shadow-sm dark:text-gray-400 sm:text-base dark:bg-gray-800 dark:border-gray-700 sm:p-4 sm:space-x-4 rtl:space-x-reverse">
        <div className="flex justify-between align-middle">
          <button className="bg-red-600 text-white py-2 px-5 mt-4">Prev</button>
          <button className="bg-green-600 text-white py-2 px-5 mt-4">
            Next
          </button>
        </div>
      </ol>
